...
def animate(iteration, data, scatters, lines, texts, ax, joint_pairs, keypoints, frames):
    ...
    for i, text in enumerate(texts):
        x, y, _ = proj3d.proj_transform(
            data[iteration, i, 0], data[iteration, i, 1], data[iteration, i, 2], ax.get_proj())
...
def skeleton_3d(directory, cam, save=False, show=False):
    ...
    scatters = [ax.scatter(points3d[0, i, 0:1], points3d[0,
                                                         i, 1:2], points3d[0, i, 2:]) for i in keypoints]
    ...
    ani = animation.FuncAnimation(fig,
                                  ...
                                  fargs=(points3d, scatters, lines, texts,
                                         ax, joint_pairs, keypoints, frames),
                                  interval=50)

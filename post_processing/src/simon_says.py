            ...
            for rep in games:
                ...
                if 'smooth' in game_rep:
                    for side in ['R', 'L']:
                        ...
                        norm_ch = conv_hull.volume/(4/3*np.pi*arm_l**3)
                        ...
                        print(
                            ...
                            f'norm convex hull: {norm_ch}; arm length: {arm_l}')
                        results.append(
                            [subj, side, bbt, age, conv_hull.volume, arm_l, norm_ch])

    results_df = pd.DataFrame(results, columns=[
                              'subject', 'side', 'bbt', 'age', 'convex_hull',
